...
(function ($, undefined) {
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            /*
            * I.V. - Commented out in order to integrate pointer events
        ...
        destroy: function () {
            ...
            if (select2 !== undefined) {
                this.destroyElement(select2.liveRegion);
                this.destroyElement(select2.dropdown);
                this.destroyElement(select2.results);
                this.destroyElement(select2.search);
                this.destroyElement(select2.container);
        ...
        monitorSource: function () {
            ...
            // IE8-10
            if ('onpropertychange' in document.body && 'attachEvent' in document.body) {
                el.get(0).attachEvent("onpropertychange", sync);
            }
