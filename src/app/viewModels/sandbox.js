define([
    ...
    'jsrender',
    'mootools-core'
    ], function($, ko, beautifyHtml, beautifyJS) {
        window.html_beautify = beautifyHtml.html_beautify;
        window.js_beautify = beautifyJS.js_beautify;
    ...
    var sandbox = new Class({
        ...
        _buildCode: function () {
            ...
            var js = this.templates['sandbox-js'];
            var jsCode = $(js).text();
            var html = this.templates['sandbox-html'];
        ...
        templateSrc: function (id, element) {
            this.templates[id] = $.templates(element).render(this);
            this.buildCode();
        },
        reset: function () {
